            ...
            <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <div className="aspect-w-16 aspect-h-9">
                  <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3988.8142338492726!2d36.81649907464118!3d-1.2854516356245136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMcKwMTcnMDcuNyJTIDM2wrA0OScwOC43IkU!5e0!3m2!1sen!2ske!4v1735835123856!5m2!1sen!2ske" 
                    width="100%" 
                    height="100%" 
                    style={{ border: 0 }} 
                    allowFullScreen 
                ...
                <p className="mt-4 text-gray-600">
                  Kenyatta Av, Dar es Salaam Rd, Shell Petrol Stn, GPO Nairobi, Kenya
                </p>
              </CardContent>
            </Card>
        ...
        <Dialog open={showSummary} onOpenChange={setShowSummary}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Thank you for contacting Albercy Auto Clinic. Here's a summary of your request:
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-2">
              <p><strong>Name:</strong> {formData.name}</p>
